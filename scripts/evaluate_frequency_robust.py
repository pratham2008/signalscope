"""Evaluate the robust Frequency v1 model on a manifest split."""
...
class FrequencyClassifierV1(torch.nn.Module):
    """Frequency v1 classifier used by the robust experiment."""
...
class InferenceDataset(Dataset):
    """Add paths to the manifest dataset."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Evaluate robust Frequency v1."
    )
    ...
    parser.add_argument(
        "--output",
        default="report/frequency_robust_vqdm_predictions.csv",
    )
