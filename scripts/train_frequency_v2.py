"""Train and calibrate SignalScope Frequency Stream v2."""
...
class FrequencyClassifierV2(nn.Module):
    """Frequency Stream v2 encoder followed by a binary classifier."""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Train Frequency Stream v2."
    )
    ...
    print(
        f"frequency_width={args.frequency_width}"
    )
    ...
    for epoch in range(
        ...
        if metrics["roc_auc"] >= best_auc:
            ...
            payload = {
                "format_version": 1,
                "model_name": "frequency_stream_v2",
    ...
    print("Frequency Stream v2 training complete.")
