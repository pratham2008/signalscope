...
class RandomResolution:
    """Randomly downscale an image while preserving aspect ratio."""
...
class MultiViewDataset(Dataset):
    ...
    def __init__(
        ...
        manifest_path: str,
        split: str,
        resolution_augmentation: bool = False,
    ) -> None:
        ...
        self.random_resolution = RandomResolution(
            probability=0.5,
            min_dimension=96,
            max_dimension=256,
        )
    ...
    def __getitem__(self, index):
        ...
        if self.resolution_augmentation:
            image = self.random_resolution(image)
...
def main() -> None:
    ...
    print(
        "CLIP + FFT resolution-robust training complete."
    )
